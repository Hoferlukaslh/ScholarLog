...
classDiagram
    ...
    Module "1" *-- "many" Branche : Possède
    Module "1" *-- "many" Entree : Journalise
    Module "1" *-- "many" TypeTravail : Définit
    Branche "1" *-- "many" Note : Contient
    Entree "many" --> "1" TypeTravail : Est classé par
```
