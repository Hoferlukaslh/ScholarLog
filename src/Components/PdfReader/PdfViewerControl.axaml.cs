...
public partial class PdfViewerControl : UserControl
{
    ...
    /// <summary>
    /// Calcule le zoom pour que l'image tienne sur toute la largeur disponible
    /// </summary>
    private void AjusterALaLargeurDefaut()
    {
